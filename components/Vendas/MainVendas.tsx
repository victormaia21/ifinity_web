    ...
    return (
        <Box component="main" sx={{ flexGrow: 1, p: 3, paddingTop: '3.75em' }}>
            <div className="w-[97%] m-auto">
                ...
                <section className="pt-10 pb-10 gap-3 md:flex md:w-1/2">
                    <div className="md:w-2/5">
                        <button className="bg-[#3fb884] text-white pt-4 pb-4 pr-1 pl-1 rounded-3xl">
                    ...
                    <div className="w-2/3 md:w-3/5">
                        <button
                            className=
                            "bg-[#e64e28] text-white pt-4 pb-4 rounded-3xl pl-1 pr-1 mt-4  md:mt-0"
                        >
                            <WarningAmberIcon />
                ...
                <section className="pt-12 pb-12 rounded-lg bg-white">
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 w-[97%] m-auto">
                    ...
                    <div className="mt-8 grid gap-1 md:flex w-[97%] m-auto">
                        <button className="bg-red-100 text-[#e0b9c0] w-full pt-3 pb-3 rounded-lg md:w-1/4">Limpar Filtros</button>
                        <button className="bg-[#05d69d] w-full pt-3 pb-3 rounded-lg text-white md:w-1/4">Filtrar</button>
                    </div>
                </section>
                ...
                <section className="border-t-[1px] border-t-[#ccc] mt-8">
                    <div className="bg-white mt-8 rounded-xl border-b-[1px] border-b-[#ccc]">
                        ...
                        <div className="hidden border-t-[#ccc] border-t-[1px] tableResponsive:block">
                        ...
                        <div className="border-t-[1px] border-t-[#ccc] w-[95%] mt-4 ml-auto mr-auto">
                            <div className="grid md:flex md:pt-4">
                                {/* Article desta section */}
                                <div className="grid h-1 w-full gap-3 pl-6 pr-6 sm:grid-cols-2 mt-4 sm:grid-rows-none md:w-4/6">
                                    ...
                                    <div className="border-[1px] border-black text-center pt-3 pb-3 rounded-2xl col-span-full">
                                        <span className="md:flex md:justify-center md:items-center">
                                                <h2 className="font-bold">ID do pedido:</h2>
                                                <p>200000000000391283192381</p>
                                        </span>
                                        <span className="md:flex md:justify-center md:items-center">
                                                <h2 className="font-bold mt-3">Item MeLi ID:</h2>
                                                <p>36742394024239</p>
                                        </span>
                                    </div>
                                ...
                                <div className="w-full pb-3 mt-[20em] md:mt-0 md:w-2/6">
                                    <div className="md:border-l-[1px] md:border-l-[#ccc]">
                                        <div className="grid justify-center gap-4 border-b-[1px] border-b-[#ccc] pb-6 w-[80%] m-auto">
                                            {/* pedidos, impostos e etc */}
                                            <div className="flex justify-between items-center">
                                                <div className="flex items-center">
                                                    {/* Icone */}
                                                    <span className="bg-[#def6de] p-2 rounded-full flex justify-center items-center w-12 h-12">
                                            ...
                                            <div className="flex justify-between items-center">
                                                <div className="flex gap-3">
                                                    {/* Icone */}
                                                    <span className="bg-[#fce8ec] h-12 w-12 rounded-full flex items-center justify-center">
                                            ...
                                            <div className="flex justify-between items-center">
                                                <div className="flex items-center gap-3">
                                                    {/* Icone */}
                                                    <span className="bg-[#fce8ec] h-12 flex justify-center items-center rounded-full w-12">
                                            ...
                                            <div className="flex justify-between items-center gap-3">
                                                <div className="flex gap-3">
                                                    {/* Icone */}
                                                    <span className="flex justify-center items-center bg-[#fce8ec] h-12 w-12 rounded-full">
                                            ...
                                            <div className="flex justify-between items-center gap-3">
                                                <div className="flex gap-3 items-center">
                                                    {/* Icone */}
                                                    <span className="bg-[#fce8ec] flex items-center justify-center rounded-full h-12 w-12">
                ...
                <section className="border-t-[1px] border-t-[#ccc] mt-8">
                    <div className="bg-white pb-12 mt-8 rounded-xl border-b-[1px] border-b-[#ccc]">
                        <div className="grid justify-center sm:flex sm:justify-between">
                            <div className="grid grid-cols-2 justify-start w-1/2 pt-3 pb-3 items-center gap-9 ml-10 sm:flex sm:ml-0 sm:gap-2">
                                <span className="bg-[#80bf83] w-6 h-6 ml-4 rounded-full"></span>
                                <span className="flex items-center">
                ...
                <div className="grid justify-center mt-8 sm:justify-between sm:flex sm:items-center">
                    <div className="grid gap-2 grid-cols-3 sm:flex">
                        <button className="bg-[#05d79f] h-11 w-11 rounded-full text-white">1</button>
                        <button className="h-11 w-11 rounded-full border-[1px] border-[#ccc] bg-[#fff7f7]">2</button>
                        <button className="h-11 w-11 rounded-full border-[1px] border-[#ccc] bg-[#fff7f7]">3</button>
                        <button className="h-11 w-11 rounded-full border-[1px] border-[#ccc] bg-[#fff7f7]">4</button>
                        <button className="h-11 w-11 rounded-full border-[1px] border-[#ccc] bg-[#fff7f7]">5</button>
                        <button className="h-11 w-11 rounded-full border-[1px] border-[#ccc] bg-[#fff7f7]">6</button>
                        <span>...</span>
                        <button className="h-11 w-11 rounded-full border-[1px] border-[#ccc] bg-[#fff7f7]">16</button>
                    </div>
                    <div className="flex gap-2 justify-center mt-3">
                        <button className="bg-white pl-5 pr-5 rounded-2xl border-[1px] border-[#ccc] sm:pl-3 sm:pr-3">
